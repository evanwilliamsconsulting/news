...
schema = Schema((
    ...
    StringField(
        ...
        widget=StringField._properties['widget'](
            label='Credit',
            label_msgid='Newspaper_label_credit',
            i18n_domain='Newspaper',
        ),
    ),
    ImageField(
...
Picture_schema  = BaseSchema.copy() + schema.copy()

##code-section after-schema #fill in your manual code here
##/code-section after-schema
class PictureJSON(BrowserView):
    """ JSON Encoded Issue """
	...
	attributes['picturepath']=pixpath
	json_item['attributes']=attributes
	pretty = json.dumps(json_item)    
	return pretty 

class Picture(BaseContent,BrowserDefaultMixin):
    """
    """
    security = ClassSecurityInfo()

    implements(interfaces.IPicture)
...
registerType(Picture, PROJECTNAME)
# end of class Image
