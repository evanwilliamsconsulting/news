...
class TextColumn(Element):
		...
		if removeTag == True:
		    ...
		    if char == '<':
		        removeTag=True
                        ...
                        self.drawALine(c,x,y,line,outline)
                        line = ""
                        y -= space
		    else:
                        line += char
    ...
    def drawALine(self,c,x,y,theLine,outline):
        sRed = 0
        sGreen = 0
        sBlue = 0            
        ...
        for article in articles:
            ...
            for char in verbage:
                if char != '\n' and char != '\r':
                    ...
                    line = ""
                    i += 1
        json_item['lines']=json_lines
        json_item['type']='TextColumn'
    ...
    def getSnapshot(self,width,height):
        ...
        text = "<div style='background:white;' class='textcolumn'>"
        articles = self.getWordage()
