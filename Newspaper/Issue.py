...
schema = Schema((
    ...
    FixedPointField(
        ...
        widget=FixedPointField._properties['widget'](
            label='paperWidth',
            label_msgid='Newspaper_label_paperWidth',
            i18n_domain='Newspaper',
        ),
    ),
    FixedPointField(
        ...
        widget=FixedPointField._properties['widget'](
            label='paperHeight',
            label_msgid='Newspaper_label_paperHeight',
            i18n_domain='Newspaper',
        ),
    ),
    FixedPointField(
    ...
    TextField(
        ...
        widget=TextField._properties['widget'](
            label='Brace',
            label_msgid='Newspaper_label_brace',
            i18n_domain='Newspaper',
        ),
...
class IssueJSON(BrowserView):
	...
	json_item['NumberOfPages']=numberOfPages
...
class Issue(BaseFolder,BrowserDefaultMixin):
    ...
    def pdfshow(self,REQUEST): 
        ...
        pdf
        """
	theTemplate = PDFPageTemplate('issue','/opt/newholland/press/products/Newspaper/issue.pd')
	parent = self.aq_inner
        return theTemplate.pt_render(REQUEST,parent,False)
    
    def outline(self,REQUEST): 
        """
        pdf
        """
        theTemplate = PDFPageTemplate('outline','/opt/newholland/press/products/Newspaper/outline.pd')
        parent = self.aq_inner
        return theTemplate.pt_render(REQUEST,parent,True)    
