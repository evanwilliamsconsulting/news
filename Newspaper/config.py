...
ADD_CONTENT_PERMISSIONS = {
    ...
    'PixLink': 'Newspaper: Add PixLink',
    'Picture': 'Newspaper: Add Picture',
    ...
    'Rectangle': 'Newspaper: Add Rectangle',
...
setDefaultRoles('Newspaper: Add PixLink', ('Contributor','Editor','Manager','Owner'))
setDefaultRoles('Newspaper: Add Picture', ('Contributor','Editor','Manager','Owner'))
setDefaultRoles('Newspaper: Add Graphic', ('Contributor','Editor','Manager','Owner'))
setDefaultRoles('Newspaper: Add Rectangle', ('Contributor','Editor','Manager','Owner'))
...
setDefaultRoles('Newspaper: Add Bucket', ('Contributor','Editor','Manager','Owner'))
