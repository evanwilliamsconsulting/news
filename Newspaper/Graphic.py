...
from interfaces import IGraphic,IBlock
import interfaces
...
Graphic_schema = OrderedBaseFolderSchema.copy() + \
    BlockishSchema.copy()

##code-section after-schema #fill in your manual code here
##/code-section after-schema

class GraphicJSON(BrowserView):
    """ JSON Encoded Issue """
...
class GraphicDiagnostics(BrowserView):
    """
    """
    def __init__(self,context,request):
        """
...
class FullGraphicView(BrowserView):
    """
    """
    def __init__(self,context,request):
        """
...
class Graphic(OrderedBaseFolder,  BrowserDefaultMixin):
    """
    ...
    implements(interfaces.IGraphic,interfaces.IBlock)
	...
	# New Graphic must be positioned outside of Bounding Box.
...
#		if fH > useheight:
    ...
    security.declarePublic('showGraphic')
