...
schema = Schema((
    ...
    StringField(
        ...
        widget=StringField._properties['widget'](
            label='Name',
            label_msgid='PlacardSet_label_Name',
            i18n_domain='PlacardSet',
        ),
    ),
),
)
...
PlacardSet_schema = BaseFolderSchema.copy() + \
    schema.copy()

##code-section after-schema #fill in your manual code here
##/code-section after-schema

class PlacardSet(OrderedBaseFolder, BrowserDefaultMixin):
    """
    """
    security = ClassSecurityInfo()

    implements(interfaces.IPlacardSet)

    meta_type = 'PlacardSet'
    _at_rename_after_creation = True

    schema = PlacardSet_schema
...
registerType(PlacardSet, PROJECTNAME)
# end of class PlacardSet
